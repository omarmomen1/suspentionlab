...
import CAEExport from "../../components/CAEExport";
...
{toast && (
      ...
      <div className="flex items-center justify-between shrink-0 pb-3 border-b border-[#1e1e1e]">
        ...
        <div className="flex items-center gap-2">
          ...
          <ShareSession currentParams={params} vehicleType="FULL_CAR" />
          ...
          {hasResults && r && (
            <div id="sim-report" className="flex flex-col gap-3 flex-1 overflow-hidden">
              ...
              <div className="flex-1 bg-[#111113] border border-[#1e1e1e] rounded-xl overflow-hidden min-h-0">
                ...
                {activeTab === 0 && (
                  <div className="grid grid-cols-1 lg:grid-cols-2 auto-rows-[350px] gap-px bg-[#181818] overflow-y-auto custom-scrollbar h-full">
                    ...
                    <PlotBox>
                      <Plot
                        data={[ 
                          { x: r.time, y: r.theta.map((v: number) => v * 180 / Math.PI), type: "scatter", mode: "lines", name: "Pitch Angle theta", line: { color: "#00ff87", width: 2 } },
                          { x: r.time, y: r.phi.map((v: number) => v * 180 / Math.PI), type: "scatter", mode: "lines", name: "Roll Angle phi", line: { color: "#bf5af2", width: 2 } } 
                        ]}
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 auto-rows-[350px] gap-px bg-[#181818] overflow-y-auto custom-scrollbar h-full">
                    <PlotBox>
                      <Plot
                        ...
                        layout={darkLayout({ title: { text: "Roll vs Pitch Space", font: { color: "#888", size: 11 } }, xaxis: { ...DARK_BASE.xaxis, title: { text: "Roll phi (°)", font: { color: "#444", size: 10 } } }, yaxis: { ...DARK_BASE.yaxis, title: { text: "Pitch theta (°)", font: { color: "#444", size: 10 } } } })}
                        useResizeHandler style={{ width: "100%", height: "100%" }} config={{ responsive: true, displayModeBar: true }}
                      />
                    </PlotBox>
                    <PlotBox>
                    ...
                    <PlotBox>
                      <Plot
                        ...
                        layout={darkLayout({ title: { text: "Roll Phase Portrait", font: { color: "#888", size: 11 } }, xaxis: { ...DARK_BASE.xaxis, title: { text: "phi (°)", font: { color: "#444", size: 10 } } }, yaxis: { ...DARK_BASE.yaxis, title: { text: "phiÌ‡ (°/s)", font: { color: "#444", size: 10 } } } })}
                        useResizeHandler style={{ width: "100%", height: "100%" }} config={{ responsive: true, displayModeBar: true }}
                      />
                    </PlotBox>
                    <PlotBox>
                ...
                {activeTab === 3 && r?.psd_freqs && (
                  <div className="grid grid-cols-1 grid-rows-1 h-full gap-px bg-[#181818]">
                    <PlotBox>
                      <Plot
                        data={[ { x: r.psd_freqs, y: r.psd_values, type: "scatter", mode: "lines", name: "PSD Roll", fill: "tozeroy", fillcolor: "rgba(191,90,242,0.06)", line: { color: "#bf5af2", width: 2 } } ]}
