...
interface SimHistoryProps {
  ...
  renderParams?: (params: Record<string, any>, metrics: any) => [string, number | string | undefined][];
}

export default function SimHistory({ storageKey, onRestore, renderParams }: SimHistoryProps) {
                ...
                <div key={entry.id}
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <div className="grid grid-cols-3 gap-x-3 gap-y-0.5">
                      {(renderParams ? renderParams(entry.params, entry.metrics) : [
                        ["ks", entry.params.k_s],
                        ["c",  entry.params.c],
